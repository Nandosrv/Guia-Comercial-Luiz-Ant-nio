<script lang="ts">
  ...
  { nome: 'Polícia Militar do Estado de São Paulo', id: 2, href: '/Comercios/Policia-Militar-do-Estado-de-Sao-Paulo' },
  ...
  { nome: 'EMEF Helena Maria Luiz de Mello', id: 6, href: '/Comercios/EMEF-Helena-Maria-Luiz-de-Mello' },
  ...
  { nome: 'Trem Mineiro Bar e Restaurante', id: 16, href: '/Comercios/Trem-Minero-Bar-e-Restaurante' },
  ...
  { nome: 'Depósito de Bebidas e Mercado No Grau', id: 27, href: '/Comercios/Deposito-de-bebidas-e-mercado-no-grau' },
  ...
  { nome: 'Panificadora Delícias e Pães', id: 32, href: '/Comercios/Panificadora-Delicias-e-Paes' },
  ...
  { nome: 'Supermercado Sacchi e Guedes', id: 45, href: '/Comercios/Supermercado-Sacchi-e-Guedes' },
  ...
  { nome: 'Unidade de Saúde Dr. Eílio Serafim', id: 48, href: '/Comercios/Unidade-de-Saude-Dr-Eilio-Serafim' },
  { nome: 'Unidade Mista de Luiz Antônio', id: 49, href: '/Comercios/Unidade-Mista-de-Luiz-Antonio' },
  { nome: 'São Francisco Saúde', id: 50, href: '/Comercios/Sao-Francisco-saude' },
  { nome: 'Sala de Vacinação Emílio Serafim', id: 51, href: '/Comercios/Sala-de-vacinacao-Emilio-Serafim' },
  ...
  { nome: 'Reabilitar Clínica de Fisioterapia', id: 58, href: '/Comercios/Reabilitar-Clinica-de-Fisioterapia' },
  { nome: 'Fisioterapia Pélvica', id: 59, href: '/Comercios/Fisioterapia-Pelvica' },
  { nome: 'Lafrois Laboratório de Análises Clínicas', id: 60, href: '/Comercios/Lafrois-Laboratorio-de-Analises-Clinicas' },
  ...
  { nome: 'Borracheiro Móvel 24h Duh Borracheiro', id: 65, href: '/Comercios/Borracheiro-movel-24h-Duh-Borracheiro' },
  { nome: 'Loja da Construção', id: 66, href: '/Comercios/Loja-da-Construcao' },
  { nome: 'Rodrigues Mat Depósito Renato', id: 67, href: '/Comercios/rodrigues-mat-deposito-renato' },
