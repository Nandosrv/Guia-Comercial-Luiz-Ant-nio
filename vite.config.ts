...
export default defineConfig({
	...
	define: {
		...
		'process.env.PUBLIC_PUBLIC_FIREBASE_CLIENT_EMAIL': JSON.stringify(process.env.PUBLIC_PUBLIC_FIREBASE_CLIENT_EMAIL),
		'process.env.PUBLIC_PUBLIC_FIREBASE_PRIVATE_KEY': JSON.stringify(process.env.PUBLIC_PUBLIC_FIREBASE_PRIVATE_KEY),
	  }
});
